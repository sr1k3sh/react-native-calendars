...
import { AccessibilityInfo, Animated, PanResponder, Text, TouchableOpacity, View } from 'react-native';
...
const ExpandableCalendar = forwardRef((props, ref) => {
    ...
    initialPosition = Positions.CLOSED, onCalendarToggled, disablePan, hideKnob = numberOfDays && numberOfDays > 1, leftArrowImageSource = undefined, rightArrowImageSource = undefined, allowShadow = true, disableWeekScroll, openThreshold = PAN_GESTURE_THRESHOLD, closeThreshold = PAN_GESTURE_THRESHOLD, closeOnDayPress = true, 
    /** CalendarList props */
    ...
    const handleScreenReaderStatus = (_screenReaderEnabled) => {
