...
const CalendarList = (props, ref) => {
    ...
    const renderItem = useCallback(({ item }) => {
        ...
        return (<CalendarListItem {...calendarProps} testID={testId} markedDates={getMarkedDatesForItem(item)} item={item} style={calendarStyle} horizontal={horizontal ?? undefined} calendarWidth={calendarWidth} calendarHeight={calendarHeight} scrollToMonth={scrollToMonth} visible={isDateInRange(item)} onHeaderLayout={onHeaderLayoutToPass}/>);
